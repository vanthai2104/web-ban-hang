...
<section class="charts">
  <section>
    <div class="container-fluid">
      <!-- Page Header-->
      <header> 
        <h1 class="h3 display">Bài viết</h1>
      </header>
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header" style="display:flex;">
              ...
              <form id="delete-post" action="{{ route('admin.post.delete') }}" method="POST" style=" display: inline;">
                ...
                <button disabled type="submit" class="btn btn-danger btn-delete">Xóa bài viết</button>
              </form>
              ...
              {{-- Form search desktop --}}
              <button class="btn btn-primary btn-create" data-url="{{ route('admin.post.create') }}">Tạo bài viết</button>
            </div>
                ...
                <table class="table table-striped table-hover" id="myTable2">
                  <thead>
                    <tr>
                      ...
                      <th class="cursor" onclick="sortTable(1)">Tác giả</th>
                      <th class="cursor" onclick="sortTable(2)">Mô tả</th>
                      <th>Nội dung</th>
                      <th></th>
                      <th></th>
                      <th></th>
